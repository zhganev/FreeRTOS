...
# 24 "/Users/georgi/GitHub/FreeRTOS/FreeRTOS.ino" 3 4
                                                              __null
# 24 "/Users/georgi/GitHub/FreeRTOS/FreeRTOS.ino"
                                                                  , 2, &task1_handle);
  ;
  status=xTaskCreate(led_red_handler, "LED_red_task", 200, 
# 26 "/Users/georgi/GitHub/FreeRTOS/FreeRTOS.ino" 3 4
                                                          __null
# 26 "/Users/georgi/GitHub/FreeRTOS/FreeRTOS.ino"
                                                              , 2, &task2_handle);
  ;
  status=xTaskCreate(led_yellow_handler, "LED_yellow_task", 200, 
# 28 "/Users/georgi/GitHub/FreeRTOS/FreeRTOS.ino" 3 4
                                                                __null
# 28 "/Users/georgi/GitHub/FreeRTOS/FreeRTOS.ino"
                                                                    , 2, &task3_handle);
  ;
...
# 61 "/Users/georgi/GitHub/FreeRTOS/FreeRTOS.ino" 3
   0 
# 61 "/Users/georgi/GitHub/FreeRTOS/FreeRTOS.ino"
   /* portUSE_WDTO to use the Watchdog Timer for xTaskIncrementTick*/ + 11) ) ) /* 2^11 = 2048 WDT scaler for 128kHz Timer*/ ) / ( TickType_t ) 1000U ) ) ) ); } while( 0 );
    digitalWrite(2, 0x0);
    do { ( void ) xTaskDelayUntil( ( &last_wakeup_time ), ( ( ( TickType_t ) ( ( ( uint32_t ) ( 1000 ) * ( TickType_t ) ( (TickType_t)( (uint32_t)128000 >> (
# 63 "/Users/georgi/GitHub/FreeRTOS/FreeRTOS.ino" 3
   0 
# 63 "/Users/georgi/GitHub/FreeRTOS/FreeRTOS.ino"
   /* portUSE_WDTO to use the Watchdog Timer for xTaskIncrementTick*/ + 11) ) ) /* 2^11 = 2048 WDT scaler for 128kHz Timer*/ ) / ( TickType_t ) 1000U ) ) ) ); } while( 0 );
  }
}
